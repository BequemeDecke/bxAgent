...
class TestBuildCodingAgent(TestCase):
    ...
    @patch("bxagent.tools.coding.agent.create_audit_agent_work_function")
    ...
    def test_build_coding_agent_subgraph(
        ...
        mock_create_audit_agent_work_function: Mock,
        ...
        mock_create_audit_agent_work_function.return_value = Mock(
            name="audit_agent_work_function"
        )
        ...
        mock_create_audit_agent_work_function.assert_called_once()
