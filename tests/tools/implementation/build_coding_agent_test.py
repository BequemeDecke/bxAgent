...
from bxagent.tools.implementation.agent import build_coding_agent_subgraph
...
class TestBuildCodingAgent(TestCase):
    ...
    def test_build_coding_agent_subgraph(
        ...
        mock_create_validation_agent_work_function: Mock,
        ...
        mock_create_validation_agent_work_function.return_value = Mock(
            name="validation_agent_work_function"
        )
        ...
        graph = build_coding_agent_subgraph(
            validation_executor=Mock(name="validation_executor"),
        ...
        mock_create_validation_agent_work_function.assert_called_once()
